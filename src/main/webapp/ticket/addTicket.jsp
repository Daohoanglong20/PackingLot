                ...
                <div class=" right col-sm-10">
                    <div class="right-content">
                        ...
                        <div class=" border-top">
                            ...
                            <div class="form-add">
                                <form method="post" action="<%=request.getContextPath()%>/addTicket"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input name="customer" type="text" class="form-control" id="customer"
                                                   required placeholder="Enter customer" value="">
                                        ...
                                        <div class="col-sm-5">
                                            <select name="trip" class="form-control " id="trip">
                                                <c:forEach items="${tripList}" var="trip">
                                                    <option value="${trip.tripID}" ${trip.bookedTicketNumber==trip.maximumOnlineTicketNumber || trip.bookedTicketNumber>trip.maximumOnlineTicketNumber?"disabled":""}>${trip.destination}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lincense" class="col-sm-2 col-form-label">License plate<span
                                                class="important">(*)</span></label>
                                        <div class="col-sm-5">
                                            <select name="licenseplate" class="form-control " id="lincense">
                                                <c:forEach items="${carList}" var="car">
                                                    <option value="${car.lincensePlate}">${car.lincensePlate}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
