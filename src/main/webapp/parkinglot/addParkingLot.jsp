                        ...
                        <div class=" border-top">
                            ...
                            <div class="form-add">
                                <form name="" method="POST"
                                      action="<%=request.getContextPath()%>/AddPackinglotServlet"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="parkingName" name="parkingName"
                                                   required placeholder="Enter Parking name" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="area" required
                                                   placeholder="Enter area" value="" name="area">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="price" required
                                                   placeholder="Enter price" value="" name="price">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="status" required
                                                   placeholder="Enter status" value="" name=status>
                                    ...
                                    <div class="col-sm-7 text-center mt-4">
                                        <a href="<%=request.getContextPath()%>/ViewPackinglotServlet" type="button"
